...
> [!NOTE]
> Managed Environment licence restrictions do not apply to the default environment as, every employee in an organization that uses the Power Platform has access to the default environment.
